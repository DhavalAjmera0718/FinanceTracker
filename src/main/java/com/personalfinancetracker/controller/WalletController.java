...
public class WalletController {
	...
	public ResponseEntity<String> UpdateWalletData(@PathVariable Long id, @RequestBody WalletProxy walletProxy)
			throws Exception {
		if (id != null) {
	...
	public ResponseEntity<String> DepositeMoney(@PathVariable("accontNumber") String accontNumber,
			@RequestBody TransactionDTO money) {
	...
	public ResponseEntity<String> trMyBankToAnotherBank(@PathVariable("accountNo") String accountNo,
			@RequestBody MultiBankTransactionDTO multiBankTrDTO) throws Exception {
		if (accountNo != null) {
			return new ResponseEntity<String>(multiSevice.trMyBankToAnotherBank(accountNo, multiBankTrDTO),
					HttpStatus.ACCEPTED);
		}
	...
	public ResponseEntity<String> DepositesFromAnotherAccount(@PathVariable("accountNo") String accountNo,
			@RequestBody MultiBankTransactionDTO mDto) {
	...
	public ResponseEntity<List<TransactionDTO>> getDataByTransactionEntity(@PathVariable("bankId") Long bankId) {
		return new ResponseEntity<List<TransactionDTO>>(service.getDataByTransactionEntity(bankId), HttpStatus.OK);
	}
